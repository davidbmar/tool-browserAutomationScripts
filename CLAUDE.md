# Claude Instructions — tool-browserAutomationScripts
...
PROJECT_ROOT=/Users/davidmar/src/tool-browserAutomationScripts OUTPUT_DIR=<framework>/dist/projects/tool-browserAutomationScripts/data ./scripts/build-sprint-data.sh
```
